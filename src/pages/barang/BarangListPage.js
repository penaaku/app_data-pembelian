...
const BarangListPage = () => {
  ...
  return (
    <NavigationWidget
      actionTop={<BarangSearchInlineWidget attr={{ variant: "secondary" }} isShowKodeBarang={true} isShowNamaBarang={true} callbackBarangSearchInlineWidget={callbackBarangSearchInlineWidget} />}
      buttonCreate={
          ...
          <tbody>
            {daftarBarang.map((barang, index) => (
              <tr key={index}>
                ...
                <td>
                  <Button onClick={() => navigate(`/barang/edit/${barang.kodeBarang}`)}>
                    <FaEdit />
                  </Button>
                </td>
              </tr>
