      ...
      <Card>
        ...
        <Card.Body>
          <Form.Group>
            ...
            <Form.Control name="kodeBarang" disabled value={barang.kodeBarang || ""} onChange={handleInput} />
          </Form.Group>
          <Form.Group className="mt-3">
            <Form.Label>Nama Barang</Form.Label>
            <Form.Control name="namaBarang" value={barang.namaBarang || ""} onChange={handleInput} />
          </Form.Group>
          <Form.Group className="mt-3">
            ...
            <Form.Control
              ...
              isInvalid={!barang.hargaBeli || parseInt(barang.hargaBeli) >= parseInt(barang.hargaJual) || parseInt(barang.hargaBeli) === 0}
          ...
          <Form.Group className="mt-3">
            ...
            <Form.Control
              ...
              isInvalid={!barang.hargaJual || parseInt(barang.hargaBeli) >= parseInt(barang.hargaJual) || parseInt(barang.hargaJual) === 0}
          ...
          <Form.Group className="mt-3">
            ...
            <Form.Control name="jumlahBarang" type="number" value={barang.jumlahBarang || ""} onChange={handleInput} />
          </Form.Group>
        </Card.Body>
      </Card>
    </NavigationWidget>
