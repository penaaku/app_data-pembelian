...
import { helperDuplicatedInArrayObject, helperHandleZero, } from "../../utils/Helper";
            ...
            <Card>
              ...
              <Card.Body>
                <Form.Group className="mt-2">
                  ...
                  <Form.Control name="faktur" type="text" isInvalid={!pembelian.faktur} value={pembelian.faktur || ""} onChange={handleInput} />
                </Form.Group>
                <Form.Group className="mt-2">
                  <Form.Label>Tanggal</Form.Label>
                  <Form.Control name="tanggal" type="date" isInvalid={!pembelian.tanggal} value={pembelian.tanggal || ""} onChange={handleInput} />
                </Form.Group>
              </Card.Body>
            </Card>
